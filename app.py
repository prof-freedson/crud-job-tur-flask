...
def criar():
    ...
    if request.method == 'POST':
        ...
        valores = (sexo, nome_passageiro, endereco, telefone, cidade_partida, cidade_destino, preco)
...
def editar(id_viagem):
    if request.method == 'POST':
        ...
        valores = (sexo, nome_passageiro, endereco, telefone, cidade_partida, cidade_destino, preco, id_viagem)
